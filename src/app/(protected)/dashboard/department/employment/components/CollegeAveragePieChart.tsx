...
const CollegeAveragePieChartInternal = dynamic(
  () =>
    import('recharts').then((recharts) => {
      ...
      function CollegeAveragePieChartComponent({
        chartData,
      }: {
      ...
      return { default: CollegeAveragePieChartComponent };
    }),
  {
    ssr: false,
...
export function CollegeAveragePieChart({ data, isLoading }: CollegeAveragePieChartProps) {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <CollegeAveragePieChartInternal chartData={chartData} />
      </CardContent>
    </Card>
  );
}
