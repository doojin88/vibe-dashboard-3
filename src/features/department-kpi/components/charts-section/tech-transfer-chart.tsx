...
const TechTransferChartInternal = dynamic(
  () =>
    import('recharts').then((recharts) => {
      ...
      function TechTransferChartComponent({
        data,
      }: {
        data: TechTransferChartData[];
      }) {
      ...
      return { default: TechTransferChartComponent };
    }),
  {
    ssr: false,
...
export function TechTransferChart({ data, isLoading }: TechTransferChartProps) {
  return (
    <ChartWrapper
      ...
      isLoading={isLoading}
    >
      <TechTransferChartInternal data={data} />
    </ChartWrapper>
  );
}
